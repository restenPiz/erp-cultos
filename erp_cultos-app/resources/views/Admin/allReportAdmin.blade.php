                        ...
                        <div class="table-responsive table-card mt-3 mb-1">
                            ...
                            <table class="table align-middle table-nowrap" id="customerTable">
                                ...
                                <tbody class="list form-check-all">
                                    @foreach ($announcementss as $announcemen)
                                        <tr>
                                            <td class="customer_nam">{{ $announcemen->id }}</td>
                                            <td class="email">{{ $announcemen->Hour }}</td>
                                            <td class="actio">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <li><a class="dropdown-item"
                                                                href="{{route('showReportAdmin',['id'=>$announcemen->id])}}"><i
                                                        ...
                                                        <li><a class="dropdown-item"
                                                                ...
                                                                data-bs-target="#deletRecordModal{{$announcemen->id }}"><i
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade zoomIn" id="deleteRecordModal{{ $announcemen->id }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('deleteAnnouncementMember', ['id' => $announcemen->id]) }}"
                                                        method="get">
                                                        @csrf
                                                        @method('DELETE')

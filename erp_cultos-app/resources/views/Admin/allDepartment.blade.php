    ...
    @role('admin')
        <div class="row">
            ...
            <div class="col-xxl-6 col-xl-6">
                ...
                <form action="{{ route('connectDepartment') }}" method="post">
                    @csrf
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Conexao de Membros a Departamento</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="customer_name">Nome do Memnbro</th>
                                            ...
                                            @foreach ($departments as $department)
                                                @if (isset($department))
                                                    ...
                                                    <div class="modal fade zoomIn"
                                                        id="deleteRecordModal{{ $department->id }}" tabindex="-1"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">

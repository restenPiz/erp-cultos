...
@section('content')
    @role('admin')
        ...
        <form action="{{ route('storeTreasurer') }}" method="post">
            @csrf
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Dados do Tesoureiro</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <!--end col-->
                                    <input type="hidden" class="form-control" id="labelInput" name="userType" value="tesoureiro">
                                </div>
                                <!--end row-->
                            </div>

            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Todos Tesoureiros</h4>
                    </div><!-- end card header -->
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="{{ route('addTreasurer') }}" class="btn btn-success add-btn"><i
                                            ...
                                            <div class="modal fade zoomIn" id="deleteRecordModal{{ $user->id }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{route('deleteTreasurer',['id'=>$user->id])}}" method="get">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="modal-body">

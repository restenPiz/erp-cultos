                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse"
                                ...
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Pedidos de Oracao</span>
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAdvanceUI">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('addAnnouncementMember') }}" class="nav-link"
                                            data-key="t-sweet-alerts">Adicionar Comunicado</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('allAnnouncementMember') }}" class="nav-link"
                                            data-key="t-nestable-list">Detalhes do Comunicado</a>
                                    </li>
                                </ul>
                            </div>
                        </li>

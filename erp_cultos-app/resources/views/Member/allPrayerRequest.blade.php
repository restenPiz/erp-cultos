                        ...
                        <div id="customerList">
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($activitie as $prayer)
                                            <tr>
                                                <td class="customer_name">{{ $prayer->Title }}</td>
                                                <td class="email">{{ $prayer->Hour }}</td>
                                                <td class="phone">{{ $prayer->Day }}</td>
                                                <td class="date">{{ $prayer->department->Name }}</td>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="customername-field"
                                                                        class="form-label">Dia</label>
                                                                    <input type="date" id="customername-field"
                                                                        class="form-control" value="{{ $prayer->Day }}"
                                                                        name="Day" required />
                                                                    <div class="invalid-feedback">Por favor escreva bem o seu
                                                                        nome
                                                                    </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select class="form-control" name="Group"
                                                                        id="status-field" required>
                                                                        <option value="{{ $prayer->Group }}">
                                                                            {{ $prayer->department->Name }}</option>

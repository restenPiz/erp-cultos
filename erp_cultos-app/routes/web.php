...
Route::group(['prefix' => 'admin', 'middleware' => ['role:admin']], function () {
    ...
    Route::post('/storeActivity', [activityController::class, 'storeActivity'])->middleware(['auth'])->name('storeCult');
    Route::get('/allActivity', [activityController::class, 'allActivity'])->middleware(['auth'])->name('allCult');
    Route::post('/updateActivity/{id}', [activityController::class, 'updateActivity'])->middleware(['auth'])->name('updateCult');
    Route::get('/deleteActivity/{id}', [activityController::class, 'deleteActivity'])->middleware(['auth'])->name('deleteCult');
